...
3. Create function to look up previous edition and run it through the plot.two function. Determine what kind of timing shift should be done, if any.
4. Add diagnostic to look for changes in input format.
...
time.series = readRDS("time.series.rds")

isbn1 = "1429231246"
isbn2 = "0312132921"

isbn.prev <- previous.edition.isbn(isbn1, title.data)
isbn.prev

plot.two("1429231246", "0716761211", time.series)
